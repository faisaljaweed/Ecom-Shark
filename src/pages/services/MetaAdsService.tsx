...
import { ArrowLeft, Monitor, Target, Image, Activity, CheckCircle } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Use demographic, interest and behaviour signals to reach high-value users on Facebook & Instagram.'
    },
    {
      icon: Image,
      title: 'Creative Optimization',
      description: 'Ad creative tailored for feeds, stories and reels to improve CTR and engagement.'
    },
    {
      icon: Monitor,
      title: 'Dynamic Ads',
      description: 'Show the right products to the right people automatically using dynamic catalog ads.'
    },
    {
      icon: Activity,
      title: 'Pixel & Conversion Tracking',
      description: 'Accurate event tracking for true measurement of conversions and ROAS.'
    }
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-300 mb-8">From awareness to conversion, we optimize campaigns for every stage of the funnel.</p>
