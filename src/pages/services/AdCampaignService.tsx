...
import AdCampaign from "../../images/img/GoogleAds.png";
  ...
  const features = [
    {
      ...
      description:
        "High-converting ad creatives tailored for each platform and audience.",
    },
    {
      icon: Target,
      title: "Audience Targeting",
      description:
        "Laser-focused audience segmentation to reach users most likely to convert.",
    },
    {
      icon: BarChart3,
      title: "Performance Reports",
      description:
        "Clear, actionable reports showing ROAS, CTR, CPA and other key metrics.",
    },
    {
      icon: Layers,
      title: "A/B Testing",
      description:
        "Systematic testing of creatives, headlines and CTAs to maximize performance.",
    },
  ];
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            End-to-end ad campaign strategy and execution across platforms —
            creative, targeting, testing, and analytics — so your ads actually
            grow your business.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-300 mb-8">
            We handle the full ad lifecycle so you can scale without wasting
            budget.
          </p>
