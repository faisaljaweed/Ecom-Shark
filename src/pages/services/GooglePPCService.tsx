...
import { ArrowLeft, Search, BarChart3, DollarSign, CheckCircle } from 'lucide-react';
...
export default function GooglePPCService() {
  const features = [
    { icon: Search, title: 'Keyword Research', description: 'Target high-intent keywords to drive relevant traffic.' },
    { icon: BarChart3, title: 'Ad Optimization', description: 'Continuously refine ad creatives and performance.' },
    { icon: DollarSign, title: 'Conversion Tracking', description: 'Measure ROI with real-time conversion tracking.' },
    { icon: CheckCircle, title: 'Budget Control', description: 'Maximize ROI by managing ad spend effectively.' }
  ];
      ...
      <div className="container mx-auto px-6 py-12">
       <Link
        ...
        <div className="bg-gray-800 rounded-2xl p-8 mb-12 border border-gray-700">
          <h2 className="text-3xl font-bold text-center mb-8">Why Google PPC?</h2>
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-6">Start Your PPC Campaign Today</h2>
          <p className="text-gray-300 mb-8">Drive more leads and grow your business with targeted Google Ads.</p>
