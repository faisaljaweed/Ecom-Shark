  ...
  const features = [
    {
      ...
      description:
        "Find the right influencers in your niche with advanced search and AI-driven recommendations.",
    },
    {
      icon: Star,
      title: "Campaign Management",
      description:
        "Plan, launch, and manage influencer collaborations all in one platform.",
    },
    {
      icon: Share2,
      title: "Engagement Tracking",
      description:
        "Measure likes, shares, comments, and reach from each influencer post.",
    },
    {
      icon: CheckCircle,
      title: "ROI Measurement",
      description:
        "Track return on investment with real-time campaign analytics and conversions.",
    },
  ];
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Collaborate with the right influencers to amplify your brand
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-6">
            Ready to Grow with Influencers?
          </h2>
          <p className="text-gray-300 mb-8">
            Expand your reach and build trust through authentic influencer
            partnerships.
          </p>
