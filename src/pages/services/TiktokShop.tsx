...
import TikTok from "../../images/img/tiktok.png";import Center_Services_Content from "./Center_Content_Services/Center_Services_Content";
;
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          <div className="flex justify-center mb-6">
            <div className="p-4 rounded-2xl">
              ...
              <img src={TikTok} alt="TikTok Shop" className="h-24 w-24 text-white" />
            </div>
          </div>
          <h1 className="text-5xl md:text-6xl text-white font-bold mb-6  bg-clip-text text-transparent">
            TikTok Shop <span className="text-[#a3e635]"> Automation </span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-[#a3e635] transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/10"
            >
